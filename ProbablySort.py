...
def custom_sort(arr):
    ...
    end_of_sorted_list = start_index
    start_of_semi_sorted_list = end_of_sorted_list + 1
    end_of_sorted_list = start_of_semi_sorted_list
    ...
    count_of_numbers_in_avg = 2 #len(unsorted_list) #(this is a good idea #johan: 'is it though' no it's not) - this was all a suggestion, it was actually good


    #std_dev = #what's this the standard deviation of again? the semi sorted list, yeha i think so
